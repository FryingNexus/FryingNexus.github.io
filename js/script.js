...
function colors() {
  ...
  if (storedColors == "FryingNexus" && colorBlind == "true") {
    document.getElementById("span-colors").innerHTML =
      '<link rel="stylesheet" href="../css/colors/light-hc.css">' +
      '<link rel="stylesheet" href="../css/colors/dark-hc.css">';
    localStorage.setItem("storedColors", "FryingNexus");
    localStorage.setItem("currentColors", "FryingNexus");
  } else if (storedColors == "FryingNexus" && colorBlind == "false") {
    document.getElementById("span-colors").innerHTML =
...
/*
If the path name is equal to "/en/shop.html" or "/fr/boutique.html"
  Display "../fr/boutique.html"
Else if the path name is equal to "/en/404.html" or "/fr/404.html"
  Display "../fr/404.html"
Else
...
function fr() {
  if (
    window.location.pathname == "/en/shop.html" ||
    window.location.pathname == "/fr/boutique.html"
  ) {
    window.location.href = "../fr/boutique.html";
  } else if (
    window.location.pathname == "/en/404.html" ||
    window.location.pathname == "/fr/404.html"
  ) {
...
/*
If the path name is equal to "/fr/boutique.html" or "/en/shop.html"
  Display "../en/shop.html"
Else if the path name is equal to "/fr/404.html" or "/en/404.html"
  Display "../en/404.html"
Else
...
function en() {
  if (
    ...
    window.location.href = "../en/shop.html";
  } else if (
    window.location.pathname == "/fr/404.html" ||
    window.location.pathname == "/en/404.html"
  ) {
